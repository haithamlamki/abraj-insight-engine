...
export function generateTemplate(type: string): Blob {
  const templates: { [key: string]: TemplateColumn[] } = {
    revenue: [
      ...
      { header: 'Budgeted Rev', width: 18, example: '672000' },
      { header: 'Diff', width: 15, example: '28000' },
    ...
    utilization: [
      ...
      { header: 'NPT Type', width: 15, example: 'Repair' },
      { header: 'Total working Days', width: 18, example: '26' },
      { header: 'Monthly Total Days', width: 20, example: '31' },
    ],
    fuel: [
      { header: 'Rig', width: 15, example: 'ADC-225' },
    ...
    billing_npt_summary: [
      ...
      { header: 'Rig Move(Reduce)', width: 18, example: '10.0' },
      { header: 'Rig Move', width: 15, example: '84.25' },
      { header: 'A.Maint', width: 15, example: '6.0' },
      { header: 'A.Maint Zero', width: 15, example: '0.0' },
